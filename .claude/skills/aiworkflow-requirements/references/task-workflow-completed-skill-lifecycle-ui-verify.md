# タスク実行仕様書生成ガイド / completed records (skill lifecycle - UI verify)

> 親仕様書: [task-workflow-completed-skill-lifecycle.md](task-workflow-completed-skill-lifecycle.md)
> 役割: completed records - UI実装・統合系（後半）
> 前半: [task-workflow-completed-skill-lifecycle-ui.md](task-workflow-completed-skill-lifecycle-ui.md)
...
- 公開判定マトリクス: SkillVisibility x CompatibilityStatus の組合せ設計
