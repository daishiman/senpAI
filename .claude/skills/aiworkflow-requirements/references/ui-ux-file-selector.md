...
モーダルは上下左右の4エリアで構成される。

| エリア     | 構成要素                                               | 説明                                               |
| ---------- | ------------------------------------------------------ | -------------------------------------------------- |
| ヘッダー   | タイトル「ファイルを選択」、閉じるボタン[×]            | モーダル上部に配置                                 |
| 検索バー   | ファイル名検索入力フィールド                           | ヘッダー直下、ツリーのフィルタリング用             |
| 左パネル   | ファイルツリー                                         | フォルダ・ファイルをチェックボックス付きで階層表示 |
| 右パネル   | 選択ファイルリスト                                     | 選択中ファイル数、一覧（個別削除可）、全クリア     |
| フッター   | 選択件数表示、「キャンセル」「選択」ボタン             | モーダル下部、アクションボタンを配置               |

**左右パネルの詳細**

| パネル   | 表示内容                                                                 |
| -------- | ------------------------------------------------------------------------ |
| 左パネル | フォルダアイコン付きディレクトリ、ファイルアイコン付きファイル、選択チェックボックス |
| 右パネル | 「N件のファイルを選択中」ヘッダー、選択ファイル名と削除ボタン、「すべてクリア」ボタン |
...
| ------- | ---------- | ------------------------------------------------------ |
| 1.1.0   | 2026-01-26 | レイアウト図のコードブロックを表形式に変換             |
| 1.0.0   | -          | 初版作成                                               |
